...
Run the following three lines of code (one at a time) in the console. *You can copy the code chunk, then paste that after the `>` in the Console. If you type the code by hand, keep in mind that spelling is important!*
