...
These results still represent a significant, positive relationship between length and weight for the Coastal Giant salamander, but this test gives a slightly smaller correlation coefficient compared to the Pearson's test on our transformed data.
